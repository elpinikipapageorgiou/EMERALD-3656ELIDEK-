# 🧠 FCM-ELM Based Clinical Prediction and Explanation System

This project implements a **Fuzzy Cognitive Map (FCM)** model enhanced with a Extreme Learning Machine **(ELM)** for predictive modeling and decision explanation in clinical datasets — specifically, for **Coronary Artery Disease (CAD)**.
...
- `mean_values.xlsx` — Pre-trained FCM weight matrix (from ELMoptimization)
