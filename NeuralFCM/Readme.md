...
* In *data* folder there are subfolders containing the datasets of the **EMERALD** project. All folders except from  *new_cad_with_experts* are empty. The folder *new_cad_with_experts* contains a sub-dataset .csv file for demonstration purposes. For accessing the project datasets you should contanct the P.I. Dr. Elpiniki Papageorgiou.
* In *models* folder the pretrained models on these datasets are provided.
