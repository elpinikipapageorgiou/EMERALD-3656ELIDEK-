...
def calculate_initial_weights(num_dimensions, initial_weight_matrix=None):
    if initial_weight_matrix is not None:
        ...
        initial_weight_matrix= np.full((num_dimensions, num_dimensions), "random")
        ...
        initial_weight_matrix[-1, :] = 0
        initial_weight_matrix = np.array(initial_weight_matrix, dtype=float)
