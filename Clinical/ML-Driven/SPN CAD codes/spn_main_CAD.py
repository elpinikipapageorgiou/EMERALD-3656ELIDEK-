...
# Load Data
csv_file_path = 'C:\\Users\\japostol\\Desktop\\HumanAI codes\\cad-2024.xlsx'  # Replace 'your_file.csv' with the actual file path
...
data=data.drop('EXPERT 1 DIAGNOSIS (1: HU, 2: U, 3: SU, 4: SL, 5: L, 6: HL) ',axis=1)
data=data.drop('EXPERT 2 DIAGNOSIS (1: HU, 2: U, 3: SU, 4: SL, 5: L, 6: HL) ',axis=1)
data=data.drop('Scintigraphy',axis=1)
data = data.fillna(0)
