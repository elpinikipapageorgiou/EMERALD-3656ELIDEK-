...
def plot_learning_curves_manual(labels,predictions_all_num,history,class_names,model_name):
    ...
    plt.savefig('C:\\Users\\User\\DSS EXPERIMENTS\\accs_{}.png'.format(model_name), dpi=300)
    plt.show()
    ...
    plt.gca().spines['right'].set_color('0.5')
    plt.gca().spines['left'].set_color('0.5')
    plt.savefig('C:\\Users\\User\\DSS EXPERIMENTS\\losses_{}.png'.format(model_name), dpi=300)
    plt.show()
