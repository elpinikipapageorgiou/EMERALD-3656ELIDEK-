...
from fcm_functions import sig, DeepFCM_ELM
...
for train_index, test_index in kf.split(dataset):
    ...
    best_fcm_weights = DeepFCM_ELM(initial_weight_matrix, num_iterations, training_dataset,num_hidden_units, learning_rate)
